...
1. [Пустая строка](#par1)
2. [Перенос строки](#par2)
3. [Разделители](#par3) 
4. [Заголовки](#par4) 
5. [Блоки кода](#par5) 
6. [Подсветка кода](#par6) 
7. [Цитаты](#par7) 
8. [Списки](#par8) 
9. [Таблицы](#par9) 
10. [Ссылки](#par10) 
11. [Специальные символы](#par11) 
12. [HTML внутри GFM и наоборот](#par12) 
13. [Изображение и видео](#par13) 
15. [Нововведение GFM](#par14) 
14. [Читать еще](#par14)    



***
1. <storng id="par1">[ Пустая строка ]</strong>
***
_(Заметка)  
...
***
_(Заметка)  
Конструкция создания в GFM изображений очень похоже на создание ссылок пункт №10 c той лишь разнице, что перед открывающей квадратной скобкой добавляетя !восклицательный знак и выглядит это так    
`![alt](http://css-live.ru/ "Опциональный title")` то же самое относиться к изображением типа "сноски", самое обидное, что с помощью синтаксиса MD или GFM не удасться задать размеры picture (width_height), изображения добавляеться в изначальном размере, по этому за этим нужно следить и пользоваться старым добрый HTML вида `<img src="www" width="x" height="x">`, что касаеться видео напрямую его добавить тоже не удасться, но есть обходные пути в примерах ниже._    
